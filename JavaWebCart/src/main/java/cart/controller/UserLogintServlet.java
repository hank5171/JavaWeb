...
public class UserLogintServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String sessionAuthcod = session.getAttribute("authcode") + "";
	
		String resultMessage = null;
		try {
			UserDTO userDTO = userLoginService.login(username, password, authcode, sessionAuthcod);
