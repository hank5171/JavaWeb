...
public class BuyServiceImpl implements BuyService {
	...
	// RuntimeException 預設會回滾, 可透過 dontRollbackOn 來改變
	// Exception 預設不會回滾, 可以透過 rollbackOn 來定義
	@Transactional(
				rollbackOn = {InsufficientAmoutException.class},
				dontRollbackOn = {RuntimeException.class}
			)
	@Override
	public void buyOneBook(String username, Integer bookId) throws InsufficientAmoutException {
