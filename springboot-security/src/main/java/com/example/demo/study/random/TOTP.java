...
public class TOTP {
	public static void main(String[] args) throws Exception {
		for(int i=1;;i++) {
			System.out.println(i + ": 我的 TOPT 密碼" + generateTOTP("admin"));
			Thread.sleep(1000);
		}
	}
	...
	public static String generateTOTP(String username) throws Exception {
		...
		// 現在秒數 30 的倍數就會更新
		long timeIntVal = System.currentTimeMillis()/1000L / 30L;
		// 得到 TOTP 密碼 
		String topt = KeyUtil.generateTOTP(secret, timeIntVal, "HMACSHA256");
		return topt;
	}
}
